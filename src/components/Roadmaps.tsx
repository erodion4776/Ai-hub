    ...
    <div className="py-12 px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {roadmaps.map((roadmap) => (
          <div key={roadmap.id} className="group bg-gray-900/50 border border-gray-800 p-8 rounded-2xl cursor-pointer hover:border-emerald-accent/50 hover:shadow-2xl hover:shadow-emerald-accent/10 transition-all duration-300" onClick={() => onRoadmapSelect(roadmap)}>
